          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="space-y-3">
              <label className="flex flex-col gap-1 text-sm">
                ...
                <input type="range" min={15} max={80} step={1} value={scenario.chargingTariffKes}
                  onChange={e => { const chargingTariffKes = Number(e.target.value); setScenario(prev => ({ ...prev, chargingTariffKes })); onInputsChange({ ...inputs, chargingTariffKes }); }}
              ...
              <label className="flex flex-col gap-1 text-sm">
                ...
                <input type="range" min={10} max={90} step={1} value={scenario.utilizationPct}
                  onChange={e => { const utilizationPct = Number(e.target.value); setScenario(prev => ({ ...prev, utilizationPct })); onInputsChange({ ...inputs, targetUtilizationPct: utilizationPct }); }}
                  className="w-full accent-emerald-400" />
              </label>
            </div>
